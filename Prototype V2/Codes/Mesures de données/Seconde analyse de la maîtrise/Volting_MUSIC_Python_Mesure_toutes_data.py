...
path = rf"C:\Users\userlisv\Desktop\Projet Volting Instrument\Prototype V2\Résultats\Mesures de données\Maîtrise\Fauteuil mécanique\donnees_volting_{timestamp}.csv"
